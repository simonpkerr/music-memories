...
--
-- Host: localhost
-- Generation Time: May 16, 2012 at 11:21 PM
...
CREATE TABLE IF NOT EXISTS `mediaresource` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_E306BA8154963938` (`api_id`),
  UNIQUE KEY `UNIQ_E306BA814FBBC852` (`mediaType_id`),
  UNIQUE KEY `UNIQ_E306BA81FF312AC0` (`decade_id`),
  UNIQUE KEY `UNIQ_E306BA814296D31F` (`genre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `mediaresourcelistingscache` (
  ...
  `mediaType_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_623D23F154963938` (`api_id`),
  UNIQUE KEY `UNIQ_623D23F14FBBC852` (`mediaType_id`),
  UNIQUE KEY `UNIQ_623D23F1FF312AC0` (`decade_id`),
  UNIQUE KEY `UNIQ_623D23F14296D31F` (`genre_id`)
