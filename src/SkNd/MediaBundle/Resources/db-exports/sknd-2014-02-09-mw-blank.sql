...
--
-- Host: localhost
-- Generation Time: Feb 09, 2014 at 05:45 PM
...
CREATE TABLE IF NOT EXISTS `mediaresource` (
  ...
  `mediaResourceCache_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mediaType_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_A90E9322685AE93D` (`mediaResourceCache_id`),
  KEY `IDX_A90E932254963938` (`api_id`),
  KEY `IDX_A90E93224FBBC852` (`mediaType_id`),
  KEY `IDX_A90E9322FF312AC0` (`decade_id`),
  KEY `IDX_A90E93224296D31F` (`genre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `mediaresourcecache` (
  `id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `xmlRef` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mediaresourcelistingscache` (
  ...
  `computedKeywords` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `xmlRef` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
  `lastModified` datetime NOT NULL,
  `mediaType_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_89FD26954963938` (`api_id`),
  KEY `IDX_89FD2694FBBC852` (`mediaType_id`),
  KEY `IDX_89FD269FF312AC0` (`decade_id`),
  KEY `IDX_89FD2694296D31F` (`genre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `memorywall` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_67EEB4A522AA2175` (`associatedDecade_id`),
  KEY `IDX_67EEB4A5A76ED395` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `MemoryWallContent`
--

CREATE TABLE IF NOT EXISTS `MemoryWallContent` (
  `id` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
  `lastModified` datetime NOT NULL,
  `comments` varchar(140) COLLATE utf8_unicode_ci DEFAULT NULL,
  `coords` longtext COLLATE utf8_unicode_ci COMMENT '(DC2Type:simple_array)',
  `flaggedComments` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `flaggedDate` datetime DEFAULT NULL,
  `isFlagged` tinyint(1) DEFAULT NULL,
  `wallIndex` int(11) DEFAULT NULL,
  `memoryWall_id` int(11) NOT NULL,
  `discr` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `imagePath` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mediaResource_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`,`memoryWall_id`),
  KEY `IDX_3C9AAFB6B154C783` (`memoryWall_id`),
  KEY `IDX_3C9AAFB666C02C1E` (`mediaResource_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `mediaresource`
  ADD CONSTRAINT `FK_A90E93224296D31F` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`),
  ADD CONSTRAINT `FK_A90E93224FBBC852` FOREIGN KEY (`mediaType_id`) REFERENCES `mediatype` (`id`),
  ADD CONSTRAINT `FK_A90E932254963938` FOREIGN KEY (`api_id`) REFERENCES `api` (`id`),
  ADD CONSTRAINT `FK_A90E9322685AE93D` FOREIGN KEY (`mediaResourceCache_id`) REFERENCES `mediaresourcecache` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_A90E9322FF312AC0` FOREIGN KEY (`decade_id`) REFERENCES `decade` (`id`);

--
-- Constraints for table `mediaresourcelistingscache`
--
ALTER TABLE `mediaresourcelistingscache`
  ADD CONSTRAINT `FK_89FD2694296D31F` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`),
  ADD CONSTRAINT `FK_89FD2694FBBC852` FOREIGN KEY (`mediaType_id`) REFERENCES `mediatype` (`id`),
  ADD CONSTRAINT `FK_89FD26954963938` FOREIGN KEY (`api_id`) REFERENCES `api` (`id`),
  ADD CONSTRAINT `FK_89FD269FF312AC0` FOREIGN KEY (`decade_id`) REFERENCES `decade` (`id`);

--
-- Constraints for table `memorywall`
--
ALTER TABLE `memorywall`
  ADD CONSTRAINT `FK_67EEB4A5A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user` (`id`),
  ADD CONSTRAINT `FK_67EEB4A522AA2175` FOREIGN KEY (`associatedDecade_id`) REFERENCES `decade` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `MemoryWallContent`
--
ALTER TABLE `MemoryWallContent`
  ADD CONSTRAINT `FK_3C9AAFB666C02C1E` FOREIGN KEY (`mediaResource_id`) REFERENCES `mediaresource` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_3C9AAFB6B154C783` FOREIGN KEY (`memoryWall_id`) REFERENCES `memorywall` (`id`);
